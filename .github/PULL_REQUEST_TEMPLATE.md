<!--
  This file is only ever seen on GitHub. GitLab ignores it.
-->

## This repository is a read-only mirror

Thank you for wanting to contribute — genuinely. But this GitHub repository is a
mirror, and **a pull request opened here cannot be merged.**
...
merged pull request. We would rather tell you now than let your work disappear.
...
[CONTRIBUTING.md](../CONTRIBUTING.md) covers what a good change looks like.

If moving this to GitLab is a real obstacle for you, say so in an issue there —
that is useful information about whether this mirror is set up the right way.
