...
([ADR-003](DECISIONS.md#adr-003-use-typescript-across-v0)). A second native SDK
waits for a team that needs one
([ADR-049](DECISIONS.md#adr-049-the-contract-is-the-deliverable-and-a-second-sdk-waits-for-a-team-that-needs-one)):
each SDK costs its build and its maintenance, and nobody has asked for a
particular language yet.
